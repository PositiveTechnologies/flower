(defproject flower "0.4.4-SNAPSHOT"
  ...
  :dependencies [[org.clojure/clojure "1.9.0"]
                 [flower/flower-tracker "0.4.4-SNAPSHOT"]
                 [flower/flower-repository "0.4.4-SNAPSHOT"]
                 [flower/flower-messaging "0.4.4-SNAPSHOT"]
                 [flower/flower-team "0.4.4-SNAPSHOT"]
                 [flower/flower-utilities "0.4.4-SNAPSHOT"]
                 [flower/flower-integration-default "0.4.4-SNAPSHOT"]
                 [flower/flower-integration-github "0.4.4-SNAPSHOT"]
                 [flower/flower-integration-gitlab "0.4.4-SNAPSHOT"]
                 [flower/flower-integration-jira "0.4.4-SNAPSHOT"]
                 [flower/flower-integration-tfs "0.4.4-SNAPSHOT"]]
