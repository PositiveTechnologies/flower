(defproject flower "0.4.1-SNAPSHOT"
  ...
  :dependencies [[org.clojure/clojure "1.9.0"]
                 [flower/flower-tracker "0.4.1-SNAPSHOT"]
                 [flower/flower-repository "0.4.1-SNAPSHOT"]
                 [flower/flower-messaging "0.4.1-SNAPSHOT"]
                 [flower/flower-team "0.4.1-SNAPSHOT"]
                 [flower/flower-utilities "0.4.1-SNAPSHOT"]
                 [flower/flower-integration-default "0.4.1-SNAPSHOT"]
